    ...
    <section id="contact" className="bg-amber-bright py-24 sm:py-32">
      <div className="mx-auto max-w-3xl px-5 text-center sm:px-8">
        <Reveal>
          ...
          <h2 className="mt-6 text-3xl font-extrabold leading-tight tracking-tight text-navy-950 sm:text-5xl">
            {contact.title}
          </h2>
          <p className="mx-auto mt-6 max-w-xl text-base leading-relaxed text-amber-ink sm:text-lg">
            {contact.description}
          </p>
          <a
